...
\item le domaine ressources pour l'analyse de la mesure dynamique de la consommation de ressources (énergie, CPU, mémoire...) sur une plateforme côté client \footnote{La mesure de plateformes PC a également été abandonnée, tandis que le développement de la mesure des objets connectés est en cours.} (mobile) ou côté serveur. 
\end{itemize}
