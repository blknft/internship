...
Pour cela j'ai ajouté deux lignes à la méthode qui effectue les différentes étapes du test automatisé, juste avant l'étape de référence (figure \ref{blank}).
...
\end{minted}
\caption{Page web blanche pour la mesure de référence}
\label{blank}
\end{figure}
